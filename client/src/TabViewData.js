        ...
        <tbody>
          {currentEntries && currentEntries.length > 0 && currentEntries.map((entry, index) => (
            ...
            >
              ...
              <td style={{ textAlign: 'justify', maxWidth: '200px',  textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{entry.nazwisko}</td>
              <td style={{ textAlign: 'justify', maxWidth: '100px', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{entry.telefon || '---'}</td>
              <td style={{ textAlign: 'justify', maxWidth: '5px',  textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{entry.jezyk}</td>
              <td style={{ textAlign: 'justify', maxWidth: '5px',  textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{entry.fs}</td>
              <td style={{ textAlign: 'justify', maxWidth: '5px',  textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{entry.nr}</td>
              <td style={{ textAlign: 'justify', maxWidth: '50px', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{entry.do_opieki}</td>
